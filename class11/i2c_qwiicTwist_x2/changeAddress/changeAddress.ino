/*
  ...
  Note: to program the new address, upload code to Teensy with only one of the Twist encoders connected
  Then, open Serial montior and type a letter into the text entry and press send
...
void setup() {
  ...
  byte newAddress = 0x77; //Address you want to change to. Valid is 0x08 to 0x77.
